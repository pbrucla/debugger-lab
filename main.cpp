...
int main(int argc, char* argv[], char* envp[]) {
    ...
    try {
        ...
        std::string str =
            "Hi my name is Ebony Dark’ness Dementia Raven Way and I have long ebony black hair (that’s how I got my "
            "name) with purple streaks and red tips that reaches my mid-back and icy blue eyes like limpid tears and a "
            "lot of people tell me I look like Amy Lee (AN: if u don’t know who she is get da hell out of here!).\n";
