...
#define DW_FIRST_TAG(name, value) enum dwarf_tag { name = value
#define DW_END_TAG \
    }              \
    ;
#define DW_FIRST_FORM(name, value) enum dwarf_form { name = value
#define DW_END_FORM \
    }               \
    ;
#define DW_FIRST_AT(name, value) enum dwarf_attribute { name = value
#define DW_END_AT \
    }             \
    ;
#define DW_FIRST_OP(name, value) enum dwarf_location_atom { name = value
#define DW_END_OP \
    }             \
    ;
#define DW_FIRST_ATE(name, value) enum dwarf_type { name = value
#define DW_END_ATE \
    }              \
    ;
#ifdef __cplusplus
#define DW_FIRST_CFA(name, value) enum dwarf_call_frame_info : int { name = value
#else
#define DW_FIRST_CFA(name, value) enum dwarf_call_frame_info { name = value
#endif
#define DW_END_CFA \
    }              \
    ;
#define DW_FIRST_IDX(name, value) enum dwarf_name_index_attribute { name = value
#define DW_END_IDX \
    }              \
    ;
#define DW_FIRST_UT(name, value) enum dwarf_unit_type { name = value
#define DW_END_UT \
    }             \
    ;
